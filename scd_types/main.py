from src.extract import extract_mss
from transform  import scd_type_1, scd_type_2, scd_type_3, scd_type_4, scd_type_5
from load import load_to_ssm
import pandas as pd
...
def main():
    ...
    incoming_df = pd.read_csv(r'C:\Users\Sravani\Downloads\customers_scd.csv')  
